...
describe('Calendar API service', function() {
  ...
  it('create a new entry', function(done){
    superagent.post('http://localhost:9000/calendar/entries')
  ...
  it('retrieves an entry by id', function(done){
    superagent.get('http://localhost:9000/calendar/entries/' + id)
      .end(function(e, res){
        // console.log(res.body);
        expect(e).to.equal(null);
  ...
  it('retrieves all calendar entries', function(done){
    superagent.get('http://localhost:9000/calendar/entries')
      .end(function(e, res){
        // console.log(res.body)
        expect(e).to.equal(null);
  ...
  it('updates an existing entry', function(done){
    superagent.put('http://localhost:9000/calendar/entries/'+id)
  ...
  it('removes an entry', function(done){
    superagent.del('http://localhost:9000/calendar/entries/'+id)
      .end(function(e, res){
        // console.log(res.body)
        expect(e).to.equal(null);
        done();
